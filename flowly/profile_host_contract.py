...
PROFILE_RPC_TIMEOUTS: dict[str, int] = {
    ...
    "mcp.access.catalog": 30_000,
    "mcp.access.list": 30_000,
    "mcp.access.create": 30_000,
    "mcp.access.revoke": 30_000,
    "mcp.chat.pending": 30_000,
    "mcp.chat.cancel": 30_000,
    "gmail.capabilities": 30_000,
    "gmail.status": 30_000,
    "gmail.setup.begin": 60_000,
    "gmail.setup.pending": 30_000,
