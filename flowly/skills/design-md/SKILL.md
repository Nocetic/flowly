---
name: design-md
description: Author, validate, and export Google's DESIGN.md design-token spec files (lint, WCAG contrast, Tailwind / DTCG export).
homepage: https://github.com/google-labs-code/design.md
metadata: {"flowly":{"emoji":"🎨","tags":["design","design-system","tokens","ui","accessibility","wcag","tailwind","dtcg"],"requires":{"bins":["npx"]},"related_skills":["writing-plans"]}}
---
...
2. **Write `DESIGN.md`** in their project root using `write_file`. Always
   ...
   A starter template lives at `templates/starter.md` next to this skill.
