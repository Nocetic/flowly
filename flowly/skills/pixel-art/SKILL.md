...
metadata: {"flowly":{"emoji":"🕹️","tags":["creative","pixel-art","arcade","snes","nes","gameboy","retro","image","video"],"requires":{"bins":["python3"]},"category":"creative","related_skills":["meme-generation"],"credits":["Hardware palettes and animation loops ported from Synero/pixel-art-studio (MIT) — https://github.com/Synero/pixel-art-studio"]}}
---
...
import os
import sys
sys.path.insert(0, f"{os.environ.get('FLOWLY_HOME', os.path.expanduser('~/.flowly'))}/skills/pixel-art/scripts")
...
```bash
cd "${FLOWLY_HOME:-$HOME/.flowly}/skills/pixel-art/scripts"
...
- ffmpeg on PATH (only needed for video — Flowly installs package this)
