...
The generative/Pollinations code is intentionally dropped; pair Flowly image
generation with `pixel_art()` for base frames when image generation is available.
