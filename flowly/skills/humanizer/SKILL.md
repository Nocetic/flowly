...
metadata: {"flowly":{"emoji":"✍️","tags":["writing","editing","humanize","anti-ai-slop","voice","prose","text"],"category":"creative","homepage":"https://github.com/blader/humanizer","author":"Siqi Chen (@blader)","license":"MIT","version":"2.5.1"}}
---
...
Also apply this skill to **your own** output when writing user-facing prose — release notes, PR descriptions, documentation, long-form explanations, summaries. Flowly's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in Flowly
