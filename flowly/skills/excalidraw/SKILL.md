---
name: excalidraw
description: "Hand-drawn Excalidraw JSON diagrams (architecture, flow, sequence). Drag-drop to excalidraw.com or upload for shareable link."
homepage: https://excalidraw.com
metadata: {"flowly":{"emoji":"✏️","tags":["excalidraw","diagrams","flowcharts","architecture","visualization","json"],"requires":{"bins":["python3"]},"install":[{"id":"pip","kind":"pip","package":"cryptography","label":"Install cryptography (pip, for upload only)"}],"related_skills":["architecture-diagram","ascii-art","design-md"]}}
---
...
```bash
python3 scripts/upload.py ~/diagrams/my_diagram.excalidraw
```
