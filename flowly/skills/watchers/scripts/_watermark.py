...
def _state_dir() -> Path:
    ...
    # Default: $FLOWLY_HOME/watcher-state/, falling back to ~/.flowly/watcher-state/.
    flowly_home = os.environ.get("FLOWLY_HOME") or str(Path.home() / ".flowly")
    return Path(flowly_home) / "watcher-state"
