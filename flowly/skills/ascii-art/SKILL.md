---
name: ascii-art
description: "ASCII art: pyfiglet banners, cowsay, boxes, image-to-ascii, curated art via ascii.co.uk."
metadata: {"flowly":{"emoji":"🎨","tags":["ascii","art","banners","creative","unicode","text-art","pyfiglet","cowsay","boxes"],"requires":{"bins":["python3","curl"]},"install":[{"id":"pip","kind":"pip","package":"pyfiglet","label":"Install pyfiglet (pip)"}],"related_skills":["excalidraw","architecture-diagram"]}}
---
...
```bash
python3 -m pyfiglet "FLOWLY" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=FLOWLY&font=Slant" | boxes -d stone
```
