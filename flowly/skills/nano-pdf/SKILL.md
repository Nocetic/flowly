---
name: nano-pdf
description: "Edit PDF text/typos/titles via nano-pdf CLI using natural-language prompts."
homepage: https://pypi.org/project/nano-pdf/
metadata: {"flowly":{"emoji":"📝","tags":["pdf","documents","editing","nlp","productivity"],"requires":{"bins":["nano-pdf"]},"install":[{"id":"pip","kind":"pip","package":"nano-pdf","bins":["nano-pdf"],"label":"Install nano-pdf (pip)"}],"related_skills":["ocr-and-documents","summarize"]}}
---
