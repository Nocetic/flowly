...
- `references/examples/commercial-aircraft-structure.md` — fuselage curves + tapered wings + ellipse engines
- `references/examples/wind-turbine-structure.md` — underground foundation, tubular tower, nacelle cutaway
- `references/examples/smartphone-layer-anatomy.md` — exploded-view stack with alternating labels
- `references/examples/apartment-floor-plan-conversion.md` — walls, doors, windows, proposed changes
