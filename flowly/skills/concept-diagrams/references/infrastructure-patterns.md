...
- `references/examples/smart-city-infrastructure.md` — hub-spoke with multiple subsystems
- `references/examples/electricity-grid-flow.md` — voltage hierarchy, flow markers
- `references/examples/wind-turbine-structure.md` — cross-section with legend
