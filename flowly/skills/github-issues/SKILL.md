...
metadata: {"flowly":{"emoji":"🐛","tags":["github","issues","project-management","bug-tracking","triage"],"requires":{"bins":["git","curl"]},"install":[{"id":"gh","kind":"brew","formula":"gh","bins":["gh"],"label":"Install GitHub CLI (optional, brew)"}],"related_skills":["github","github-pr-workflow"]}}
---
