---
name: searxng-search
description: "Free meta-search via SearXNG — aggregates results from 70+ search engines. Self-hosted or use a public instance. No API key needed. Set SEARXNG_URL to your instance. Helper script in scripts/searxng.sh."
metadata: {"flowly":{"emoji":"🔎","tags":["search","searxng","meta-search","self-hosted","free","fallback"],"requires":{"bins":["curl","jq"],"env":["SEARXNG_URL"]}}}
---
