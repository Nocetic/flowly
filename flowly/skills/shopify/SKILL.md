---
name: shopify
description: "Shopify Admin & Storefront GraphQL APIs via curl. Products, orders, customers, inventory, metafields. Requires SHOPIFY_ACCESS_TOKEN and SHOPIFY_STORE_DOMAIN env vars."
metadata: {"flowly":{"emoji":"🛍️","tags":["shopify","e-commerce","commerce","api","graphql"],"requires":{"bins":["curl","jq"],"env":["SHOPIFY_ACCESS_TOKEN","SHOPIFY_STORE_DOMAIN"]}}}
---
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Flowly","productType":"Apparel","tags":["test"]}}'
```
