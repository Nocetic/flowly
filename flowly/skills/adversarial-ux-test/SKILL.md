...
metadata: {"flowly":{"emoji":"🧨","tags":["qa","ux","testing","adversarial","dogfood","personas","user-testing"],"requires_tools":["browser_tab"],"category":"qa","related_skills":["dogfood","flowly-browser"]}}
---
