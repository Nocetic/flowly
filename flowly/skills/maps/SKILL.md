---
name: maps
description: "Geocoding, POIs, routes, timezones via OpenStreetMap/OSRM. Free, no API key, Python stdlib only."
homepage: https://www.openstreetmap.org/about
metadata: {"flowly":{"emoji":"🗺️","tags":["maps","geocoding","places","routing","distance","directions","nearby","location","openstreetmap","nominatim","osrm"],"requires":{"bins":["python3"]},"related_skills":["weather","here-now","summarize"]}}
---
...
Script lives at `scripts/maps_client.py` inside this skill directory.

## Commands

```bash
# Resolve the script path once. If you cd'd into the skill dir, just use ./scripts/maps_client.py.
MAPS=~/.flowly/skills/maps/scripts/maps_client.py
```
...
```bash
python3 ~/.flowly/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 ~/.flowly/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
