---
name: xurl
description: "X (Twitter) via xurl CLI: post, search, DM, media, full v2 API. OAuth 2.0 PKCE auto-refresh."
homepage: https://github.com/xdevplatform/xurl
metadata: {"flowly":{"emoji":"🐦","tags":["twitter","x","social-media","xurl","official-api"],"platforms":["macos","linux"],"requires":{"bins":["xurl"]},"install":[{"id":"brew","kind":"brew","formula":"xdevplatform/tap/xurl","cask":true,"bins":["xurl"],"label":"Install xurl (brew, macOS)"},{"id":"shell","kind":"shell","cmd":"curl -fsSL https://raw.githubusercontent.com/xdevplatform/xurl/main/install.sh | bash","bins":["xurl"],"label":"Install xurl (shell installer)"}],"related_skills":["summarize"]}}
---
...
`xurl` is maintained by the X developer platform team, supports OAuth 2.0 PKCE with auto-refresh, and covers a substantially larger API surface than older third-party wrappers.
...
- Flowly adaptation: reformatted for Flowly skill conventions; safety guardrails preserved verbatim.
