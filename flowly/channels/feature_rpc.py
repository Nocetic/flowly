...
def mcp_capabilities() -> dict:
    ...
    from flowly.mcp.oauth_handoff import IOS_OAUTH_REDIRECT_URI, ANDROID_OAUTH_REDIRECT_URI
    ...
    return {
        ...
        "oauthCallbackModes": ["desktop_loopback", "ios_https", "android_https"] if native_oauth else [],
        "oauthRedirectUris": {"ios": IOS_OAUTH_REDIRECT_URI, "android": ANDROID_OAUTH_REDIRECT_URI} if native_oauth else {},
...
def _cron_job_to_dict(j, run: dict | None = None) -> dict:
    ...
    return {
        ...
        "retryBackoffMs": list(j.retry_backoff_ms or []),
