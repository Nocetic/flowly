...
def _sleep(say: Say) -> dict:
    return {
        ...
        "layout": [
            ...
            {"type": "divider"},
            {"type": "header", "text": say("Last 30 days", "Son 30 gün",
                                           "Últimos 30 días")},
...
TEMPLATES: tuple[Template, ...] = (
    ...
    Template(
        ...
        description=(
            "Log the night, watch the 30-day trend, get a bedtime nudge.",
            "Geceyi kaydet, 30 günlük eğilimi gör, yatma vakti hatırlatması al.",
