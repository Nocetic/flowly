...
class CronTool(Tool):
    ...
    def description(self) -> str:
        return (
            ...
            "create a cron job. Add a `watch` to that flowlet's definition (flowlet "
            "tool) instead — it fires the reminder itself with no LLM turn. Use cron "
            "only for reminders that are not about a flowlet. "
